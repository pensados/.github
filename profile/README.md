...
*Un servidor MCP que le permite a Claude o ChatGPT gestionar tu flota de servidores Linux, macOS y Windows. Multi-host, gestionado por un hub central, con allowlist de comandos y operaciones auditables.*
